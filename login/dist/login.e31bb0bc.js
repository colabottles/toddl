 ...
 */
var password = Array.from(document.querySelectorAll("[data-input]")); // Toggle the Show Passwords checkbox

var toggle = document.querySelector("#show-passwords"); // Toggle a single password field to set visibility
...
toggle.addEventListener("change", toggleAll, false); // // Login script
