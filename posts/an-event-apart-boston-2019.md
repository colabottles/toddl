...
It was terrific. Jeffrey started it off with his talk about slow design. There is too much going on, on webistes that distracts and stresses users. Designers should help users by slowing down so they can make informed decisions. &quot;Readability transcends legibility&quot;, &quot;Absorption, not conversion.&quot;. Where you read from, lying down, sitting in a chair tablet on your knees, at the breakfast table with the tablet proped up a foot away from you?  
...
Eric talked about the possibilities when using the pseudo-elements ```::before``` and ```::after``` for styling and minimalising the clutter in your HTML markup. Then how pull quotes are &quot;mismanaged&quot; and that's when I had my cringe moment. I thought I had borrowed a cool pull quote design in a blockquote from a site then tailored it even better but nay. I say nay.
...
Jen also mentioned that everything doesn't have to be done in Flexbox or Grid, that &quot;good old fashioned stuff is still good.&quot; I was fortunate enough to get a few minutes talking to Jen (Thank you so very much!) about a few questions I had and as with all the speakers I spoke to and had questions with, she was so very grcious with her time.

Overall, as how it was the last two yeas, Day One was stellar. I had a great time absorbing all the information, putting it into my log book for future use and how I may do things at work going forward.
...
Due to my height, I have had elderly people ask me to reach something on the top shelf for them and I was able to help with no problem or issue. I guess, by the talk Kate had, you can't do that in an Amazon Go store as it wont be registered correctly. So is this a meaningful experience? I dare to say, nay.

A talk I was itching to hear, Jason Pamental followed up with his talk on Dynamic Typographic Systems and Variable Fonts. Something I want to inject and use in both personal and work projects. This is and can be the now and the future!
...
Michael discussed AirBNB's approach to inclusive design. The best quote from Michael was &quot;Design systems are your leverage to do better.&quot; and that &quot;Colors project differently on different devices.&quot; couldn't have rang more true. When shown a slide of four different devices with the same hex code and four different shades of that hex color. I had a lot to take back to the office just in Michael's talk (a.k.a. Safari Dude) alone!
...
Markup order versus visual order of elements when using layouts such as Flexbox and CSS Grid, for example. A surprising example is that the Space Jam website, that is <em>still</em> online, is more accessible than the Captain Marvel aite tht is online from only this year. Amazing.
...
Jason Grigsby then took the stage to talk about web forms and "touched" on Face and Touch ID, password managers (I use LastPass and have used Dashlane and KeePass). Performed some "slight of hand" and stunned the crowd with his prestidigitation.
...
Gerry McGovern closed out yet another great conference. Gerry always puts on a great and highly entertaining talk. This and last years conference were a testament to that. Gerry spoke about focusing on your users, taking your users feedback and going to task on adjusting your design to their feedback as to work with them and design with them for your product.
...
All-in-all I was able to shed my insecurities and I was able to mingle, ask a lot of questions, and get over my anxiety over approaching people and talking to them. I got to see a lot of folks I met in 2018 and say hello. I met some nice people, talked with a few, had breakfast and lunch with speaker sand attendees alike that were and are very nice and pleasant folks who, like myself, come to learn from the best and I hope to see them next year as well.
